...
!      To avoid msg block, cutting long msg to short msgs   
       ...
       integer :: low_side_need, high_side_need

            nsize=LAP*ny*nz

       low_side_need = 0
       high_side_need = 0
       if(npx.ne.0 .or. Iperiodic1 .eq. 1) low_side_need = 1
       if(npx.ne.npx0-1 .or. Iperiodic1 .eq. 1) high_side_need = 1

       if(low_side_need == 0 .and. high_side_need == 0) return

       if(low_side_need > 0)then
        do k=1,nz
        do j=1,ny
        do i=1,LAP
   ...
   if(low_side_need > 0 .and. high_side_need > 0)then !rotation / wave
    !to low, from high
...
!------------------------------------------------------
      ...
      if(npy.ne.0 .or. Iperiodic1 .eq. 1) low_side_need = 1
      if(npy.ne.npy0-1 .or. Iperiodic1 .eq. 1) high_side_need = 1
...
!-------------------------------------------------------------------------------     
      ...
      if(npz.ne.0 .or. Iperiodic1 .eq. 1) low_side_need = 1
      if(npz.ne.npz0-1 .or. Iperiodic1 .eq. 1) high_side_need = 1
